<template>
  <div class="my-10 flex h-screen py-5 xl:my-0 xl:h-auto xl:py-0">
    ...
    >
      <h2 class="text-center text-2xl font-semibold xl:text-left xl:text-3xl">Sign Up</h2>
      <div class="mt-2 text-center opacity-70 xl:hidden">
        A few more clicks to sign up to your account. Manage all your e-commerce accounts in one
        place
      </div>
